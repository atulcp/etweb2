...
import { whoAreWeImg, journeyImg1, ceoImg2, ceoImg3, magnetsImg1, expImg1 } from '../../assets/img/imgAssets';
import { aboutJourneyData, testimonials } from '../../data/testimonialsData';
...
const EtWebAbout = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="bg-white p-10 h-screen" style={{ backgroundImage: `url(${magnetsImg1})`, backgroundSize: "cover", backgroundAttachment: "fixed" }}>
        <h2 className="text-6xl font-bold mb-4 text-orange-600">Our Approach</h2>
        <div className="w-20 h-1 bg-gray-600" />
        <p className="text-white text-4xl max-w-md py-5 leading-relaxed">Magnetization!</p>
      </div>
    </div>
  );
};
